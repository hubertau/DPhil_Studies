...
python3.9 user_twarc_timelines.py \
    ../../data/02_intermediate/02_group/group_2_sampled_weight_False_users.txt \
...
ls -alht ../../data/01_raw/02_group/ | mail -s "group 2 first collection complete" hubert.au@oii.ox.ac.uk
