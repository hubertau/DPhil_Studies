...
python3.9 user_twarc_timelines.py \
    ../../data/02_intermediate/02_group/group_2_snowball_2.txt \
...
ls -alht ../../data/01_raw/02_group/ | mail -s "group 2 second snowball collection complete" hubert.au@oii.ox.ac.uk
