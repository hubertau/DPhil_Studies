...
class Tweet_Interaction:
    ...
    reply_count: int = attr.ib(validator=attr.validators.instance_of(int))
    quote_count: int = attr.ib(validator=attr.validators.instance_of(int))
    retweet_count: int = attr.ib(validator=attr.validators.instance_of(int))
